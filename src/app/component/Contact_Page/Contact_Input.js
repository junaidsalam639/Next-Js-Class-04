...
const Contact_Input = () => {
  ...
  <div class="container px-5 py-8 mx-auto">
    <div class="flex flex-col text-center w-full mb-8">
      <h1 class="sm:text-3xl text-2xl font-bold title-font text-indigo-800">Contact Us</h1>
    </div>
      ...
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full">
          <div class="">
            ...
            <textarea id="message" name="message" class="w-full bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none transition-colors "></textarea>
          </div>
        </div>
        <div class="p-2 w-full">
